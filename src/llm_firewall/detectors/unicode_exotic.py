...
INVISIBLE_SPACES = {
    ...
    0x2000, 0x2001, 0x2002, 0x2003, 0x2004, 0x2005, 0x2006, 0x2007,  # Various spaces
    0x2008, 0x2009, 0x200A, 0x202F, 0x205F,  # More spaces
}
...
def detect_exotic_unicode(text: str) -> Tuple[str, Dict]:
    ...
    for char in text:
        ...
        if codepoint in TAG_BLOCK:
            ...
            if codepoint == 0xFB00: cleaned.append('ff'); continue
            elif codepoint == 0xFB01: cleaned.append('fi'); continue
            elif codepoint == 0xFB02: cleaned.append('fl'); continue
            elif codepoint == 0xFB03: cleaned.append('ffi'); continue
            elif codepoint == 0xFB04: cleaned.append('ffl'); continue
