...
def main():
    ...
    print(
        f"Initial risk: {evaluate_campaign_risk(detector, initial_scenario, args.t_hard)[0]:.3f}"
    )
    ...
    print(
        f"Risk reduction: {evaluate_campaign_risk(detector, initial_scenario, args.t_hard)[0] - final_risk:.3f}"
    )
    ...
    results = {
        "initial_scenario": {
            ...
            "blocked": evaluate_campaign_risk(detector, initial_scenario, args.t_hard)[
                1
            ],
        },
        "evading_scenario": {
