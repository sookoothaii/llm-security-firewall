...
def measure_fpr_with_attribution(
    corpus_path: str = "data/benign_corpus.txt", output_csv: str = "fpr_attrib.csv"
) -> dict:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--corpus", default="data/benign_corpus.txt", help="Path to benign corpus"
    )
    parser.add_argument("--output", default="fpr_attrib.csv", help="Output CSV path")
