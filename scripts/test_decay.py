...
def test_risk_decay():
    ...
    assert 1.7 < current_score_2 < 1.8, (
        f"Expected ~1.75 after 48h, got {current_score_2}"
    )
    ...
    assert 1.3 < loaded_score < 1.45, (
        f"Expected ~1.375 after offline decay, got {loaded_score}"
    )
