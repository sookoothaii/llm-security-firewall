"""
Content Safety Service API Controller

Handles HTTP requests for content safety detection.
"""
import logging
import time
...
class ContentSafetyController:
    """
    Controller for content safety detection endpoints.
    """
    ...
    def __init__(self, detection_service: DetectorPort):
        ...
        logger.info("ContentSafetyController initialized")
