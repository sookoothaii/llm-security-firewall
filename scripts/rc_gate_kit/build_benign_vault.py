...
def build_vault_from_benign_corpus(
    corpus_path: str,
...
def build_vault_from_attrib_csv(
    attrib_csv: str, output_path: str = "artifacts/benign_vault.json"
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--corpus", default="data/benign_corpus.txt", help="Benign corpus path"
    )
    parser.add_argument(
        "--output", default="artifacts/benign_vault.json", help="Output vault path"
    )
    parser.add_argument(
        "--min-freq", type=int, default=2, help="Minimum frequency to keep"
    )
