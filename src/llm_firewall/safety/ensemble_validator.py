...
class EnsembleValidator:
    ...
    def decide(
        ...
        # Rule 4: Safe
            ...
            is_threat = False
            if safe_votes > 0:
                confidence = sum(v.confidence for v in layer_votes if not v.is_threat) / safe_votes
            else:
                confidence = 0.5
    ...
    def validate(
        ...
        if perplexity_result:
            perplexity_vote = LayerVote(
                ...
                confidence=1.0 - (perplexity_result.perplexity / 1000.0) if perplexity_result.is_adversarial else 0.0,
