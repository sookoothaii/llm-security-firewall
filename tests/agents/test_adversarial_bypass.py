...
def create_tool_event(tool: str, category: str, target: str = "", timestamp: float = None, metadata: dict = None) -> ToolEvent:
...
class TestAdversarialBypass(unittest.TestCase):
    ...
    def test_semantic_abuse_of_translation_tools(self):
        ...
        self.assertTrue(
            result.is_blocked,
            "Translation-based exfiltration should be detected"
        )
