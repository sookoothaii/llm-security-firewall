...
class MSGHillClimbAttacker:
    ...
    def mutate_payload(self, payload: str, mutation_type: str) -> str:
        ...
        if mutation_type == "char_substitution":
            ...
            if positions:
                ...
                return (
                    payload[:insert_pos] + random.choice(spaces) + payload[insert_pos:]
                )
    ...
    def hill_climbing_attack(
        self, max_iterations: int = 200, queries_per_min: int = 50
    ) -> Dict:
        ...
        for iteration in range(max_iterations):
            ...
            if best_fitness > current_fitness:
                ...
                print(
                    f"Iteration {iteration}: Fitness {current_fitness:.3f} - {current_payload[:50]}..."
                )
