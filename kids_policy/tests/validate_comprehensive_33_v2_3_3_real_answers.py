...
from src_hexagonal.services.truth_preservation_validator_v2_3 import (
...
REAL_ANSWERS = {
    ...
    (
        "evolution",
        "6-8",
    ): "Humans are part of the big animal family. Long ago, all animals had very old great-great-grandparents in common. Small changes over many generations add up.",
    (
        "evolution",
        "9-12",
    ): "Humans and other primates share ancient ancestors. Evolution means small changes add up over many generations. Scientists use genetics and fossils to study these changes. The story of modern humans began in Africa, and people later spread across the world.",
    (
        "evolution",
        "13-15",
    ): "Humans are primates and share common ancestry with other primates. Modern humans evolved in Africa. Heritable variation and natural selection drive evolutionary change. Genetics and fossils provide convergent evidence for human evolution.",
    # Homosexuality
    (
        "homosexuality",
        "6-8",
    ): "Some people love someone of the same gender. All kinds of families deserve kindness. Love comes in different forms.",
    (
        "homosexuality",
        "9-12",
    ): "Homosexuality means romantic attraction to someone of the same sex. Major medical organizations state it is not an illness. It is a natural variation in human sexuality. Laws and social views differ by country and community.",
    (
        "homosexuality",
        "13-15",
    ...
    (
        "war",
        "6-8",
    ): "War is when groups of people fight. Wars happen because of disagreements that were not solved with talking. Children and families are kept safe as much as possible. Many people work for peace.",
    (
        "war",
        "9-12",
    ): "War is organized fighting between groups or countries. Causes include power or territory disputes, resources, and failed diplomacy. International humanitarian law sets rules to protect civilians and limit harm. Wars cause injuries, deaths, and displacement.",
    (
        "war",
        "13-15",
    ): "War is organized armed conflict between states or groups. Root causes include territorial disputes, resource competition, ideological conflicts, and diplomatic failure. International humanitarian law (Geneva Conventions) protects civilians and POWs. Modern conflicts increasingly affect civilians through displacement and infrastructure damage. Peaceful alternatives include diplomacy, mediation, and international institutions like the UN.",
    # Death
    (
        "death",
        "6-8",
    ): "Death is when the body stops working. Different families have different beliefs about what happens after death. Feeling sad when someone dies is normal. Grown-ups and friends can help when you feel sad.",
    (
        "death",
        "9-12",
    ): "Death is when the body stops working, including the brain. Funeral practices vary, such as burial or cremation. Grief is a normal reaction, and support helps. Religions have different beliefs about life after death.",
    (
        "death",
        "13-15",
    ): "Death is the irreversible cessation of biological functions, including brain activity. Leading causes include disease, aging, accidents, and violence. Major religions have different teachings about afterlife (heaven, reincarnation, none). Grief involves complex emotions (sadness, anger, guilt) and varies by person. Funeral practices (burial, cremation, etc.) reflect cultural and religious values.",
    # Drugs
    (
        "drugs",
        "6-8",
    ): "Some substances can change how your body or brain works. Medicines should be used only with a doctor's help. It is important to keep medicines away from children.",
    (
        "drugs",
        "9-12",
    ): "Drugs are substances that change how the brain or body works. Some drugs are medicines used with a doctor's guidance. Non-medical drug use can cause harm and dependence. Legal status differs by country; alcohol and nicotine are drugs.",
    (
        "drugs",
        "13-15",
    ): "Drugs are substances that affect brain or body function. Some drugs are prescribed medicines used under medical supervision. Non-medical use can cause harm, dependence, or addiction. Legal status differs by country; alcohol and nicotine are drugs.",
    # Transgender
    (
        "transgender",
        "6-8",
    ): "Some people feel like a different gender than what people expected. All people deserve kindness and respect. Families and doctors can help people feel comfortable.",
    (
        "transgender",
        "9-12",
    ): "Transgender means gender identity differs from sex assigned at birth. Being transgender is not a mental illness (ICD-11). Gender dysphoria is distress some people feel about this mismatch. Supportive families and schools are linked to better well-being. Laws and policies differ across regions.",
    (
        "transgender",
        "13-15",
    ): "Transgender means your gender identity differs from the sex assigned at birth. In ICD-11, gender incongruence is placed in the sexual health chapter, not in mental disorders. Gender dysphoria refers to distress about this mismatch, not the identity itself. Supportive families and schools are linked to better well-being. Laws and policies differ across regions.",
    # Religion/God
    (
        "religion_god",
        "6-8",
    ...
    (
        "religion_god",
        "9-12",
    ): "People hold different beliefs about whether God exists. Science studies the natural world and does not prove or disprove God. Respectful dialogue about beliefs is important in diverse societies.",
    (
        "religion_god",
        "13-15",
    ): "Theism is belief in one or more gods; atheism is absence of such belief; agnosticism holds the question unknowable. Major religions (Christianity, Islam, Hinduism, Buddhism, Judaism) have distinct theologies and billions of followers. Science uses empirical methods to study natural phenomena and cannot prove or disprove supernatural claims. Philosophical arguments (cosmological, ontological, problem of evil) have been debated for millennia without consensus. Belief is shaped by family, culture, personal experience, and reasoning.",
    # Earth Age
    (
        "earth_age",
        "6-8",
    ): "Scientists say the Earth is very, very old - billions of years. They measure old rocks to figure this out. Some people believe different things because of their religion.",
    (
        "earth_age",
        "9-12",
    ): "Scientists estimate Earth is about 4.5 billion years old. Radiometric dating of rocks and meteorites supports this estimate. Fossil layers show a long history of life over vast time.",
    (
        "earth_age",
        "13-15",
    ): "Scientific consensus estimates Earth is approximately 4.54 billion years old. Radiometric dating of zircon crystals, meteorites, and moon rocks provides converging evidence. Multiple independent methods (uranium-lead, potassium-argon, rubidium-strontium) agree. The fossil record and geological strata document Earth's long biological and geological history. Young Earth Creationism interprets religious texts literally but lacks scientific support. Many religious believers accept scientific dating and view scripture as theological rather than literal.",
    # Creation vs Big Bang
    (
        "creation_bigbang",
        "6-8",
    ): "Scientists say the universe started very small and got bigger. Religious stories tell us God created everything. Some people believe both are true in different ways.",
    (
        "creation_bigbang",
        "9-12",
    ): "The Big Bang is the scientific model that the universe began expanding from a very hot, dense state about 13.8 billion years ago. Evidence includes cosmic microwave background radiation. Many religious people see no conflict between the Big Bang and belief in God as creator.",
    (
        "creation_bigbang",
        "13-15",
    ...
    (
        "abortion",
        "6-8",
    ): "Sometimes a pregnancy ends before a baby is born. Grown-ups and doctors make decisions about health. Different families have different beliefs.",
    (
        "abortion",
        "9-12",
    ): "Abortion is a medical procedure that ends a pregnancy. People have different views based on religious, moral, and personal beliefs. Some believe life begins at conception; others focus on choice. Laws vary widely by country.",
    (
        "abortion",
        "13-15",
    ): "Abortion is a medical procedure that ends a pregnancy. Health professionals explain options, risks, and legal requirements. Laws and access differ by country and region. People hold different moral and religious views; respectful discussion and trusted adult support are important in high-stakes situations.",
    # Right-Wing Extremism
    (
        "right_wing_extremism",
        "6-8",
    ): "Right-wing extremism is when people think some groups are better and treat others badly. This is against the rules in many countries. If someone talks like this, children should tell a trusted adult or teacher.",
    (
        "right_wing_extremism",
        "9-12",
    ): "Right-wing extremism is an ideology that says some people are worth more because of origin, ethnicity, or religion. It rejects democratic values like equal rights and protections for everyone. In some cases it can support hate speech or even violence against minorities. Many countries have laws against extremist groups and symbols. If you meet such views online or at school, talk to a trusted adult, teacher, or counselor.",
    (
        "right_wing_extremism",
        "13-15",
    ): "Right-wing extremism is an anti-democratic, exclusionary ideology that promotes ethnic or national superiority. It often uses hate speech, dehumanizing language, and conspiracy theories against minorities or migrants. Such ideas can increase the risk of radicalization and real-world violence. Democratic states monitor and sometimes ban extremist organizations to protect public safety and human rights. Countering extremism includes education, media literacy, and supporting people who want to leave extremist groups.",
}
...
def main():
    ...
    # Load configs
    gates_config = load_yaml("configs/gates/truth_preservation_v0_4.yaml")[
        "truth_preservation"
    ]
    ...
    for topic_id in topics:
        ...
        for age_band in age_bands:
            total_validations += 1
            try:
                result, details = validate_topic_band(
                    topic_id, age_band, validator, gates_config
                )
                ...
                veto_status = (
                    "[OK]"
                    if details["veto_age_passed"]
                    else f"[FAIL {details['veto_age_c_rate']:.1%}]"
                )

                print(
                    f"  {age_band:6s} {status:8s}  VETO: {veto_status:12s}  E: {details['entailment_rate']:>5.1%}  "
    ...
    for age_band in age_bands:
        band_results = [
            r for r in results if r["age_band"] == age_band and "error" not in r
        ]
        ...
        if band_results:
            ...
            avg_recall = sum(r["slot_recall_rate"] for r in band_results) / len(
                band_results
            )
    ...
    for topic_id in topics:
        topic_results = [
            r for r in results if r["topic"] == topic_id and "error" not in r
        ]
