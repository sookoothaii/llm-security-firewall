...
extreme = [
    ...
    (
        "triple",
        base64.b64encode(
            base64.b64encode(base64.b64encode(b"DROP TABLE users"))
        ).decode(),
    ),
    ...
    (
        "nested_url",
        base64.b64encode(
            b"data:text/html," + base64.b64encode(b"<script>alert(1)</script>")
        ).decode(),
    ),
    ...
    (
        ...
        base64.b64encode(
            b"DROP".translate(
                bytes.maketrans(
                    b"ABCDEFGHIJKLMNOPQRSTUVWXYZ", b"NOPQRSTUVWXYZABCDEFGHIJKLM"
                )
            )
        ).decode(),
    ),
