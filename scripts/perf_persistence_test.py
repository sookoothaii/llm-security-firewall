...
def run_performance_test(num_sessions=100, events_per_session=50, concurrency=10):
    print("======================================================================")
    print("PERFORMANCE TEST: Persistence Layer")
    print(
        f"Sessions: {num_sessions} | Events/Session: {events_per_session} | Concurrency: {concurrency}"
    )
    print("Database: SQLite (hakgal_firewall.db)")
    print("======================================================================")
